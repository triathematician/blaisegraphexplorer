...
public class TimeMetricPlot extends javax.swing.JPanel
    ...
    public void setController(TimeGraphController tgc) {
        if (this.gc != null) {
            ...
            gc.getStatController().removePropertyChangeListener(this);
            gc.getDecorController().removePropertyChangeListener(this);
        }
        this.gc = tgc;
        if (tgc != null) {
    ...
    void updateChart() {       
        ...
        if (lg == null || metric == null || set == null || set.isEmpty()) {
            ...
            chart.setPrimaryViz(new XYViz(m, false));
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        if (pn.equals("filteredGraph") || pn.equals("filterThreshold")
                || pn.equals("metric") || pn.equals("metricValues") || pn.equals("highlightNodes"))
            updateChart();
    }
