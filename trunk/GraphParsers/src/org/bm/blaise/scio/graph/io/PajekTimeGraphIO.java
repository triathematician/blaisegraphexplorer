 ...
 * @author elisha
 */
public class PajekTimeGraphIO extends AbstractGraphIO {

    // no instantiation
    private PajekTimeGraphIO() {}

    // single instance
    private static final PajekTimeGraphIO INSTANCE = new PajekTimeGraphIO();

    /** Factory method @return instanceo of this IO class */
    public static PajekTimeGraphIO getInstance() { return INSTANCE; }
    ...
    public Object importGraph(Map<Integer,double[]> locations, File file, GraphType type) {
        ...
        ListTimeGraph<Integer> result = new ListTimeGraph<Integer>();
    ...
    public GraphType saveGraph(Object go, Map<Object,Point2D.Double> positions, File file) {
        TimeGraph<Integer> lg = null;
        try {
            lg = (TimeGraph<Integer>) go;
