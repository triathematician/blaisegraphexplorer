...
public class ExplorerIOActions {
    ...
    class LoadAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (fc.openFile != null) {
                fc.setCurrentDirectory(fc.openFile);
                fc.setSelectedFile(fc.openFile);
            }
            if (fc.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                fc.openFile = fc.getSelectedFile();
                TreeMap<Integer, double[]> loc = new TreeMap<Integer, double[]>();
                AbstractGraphIO loader = fc.activeIO();
                if (loader == null)
                    return;
                Object loaded = loader.importGraph(loc, fc.openFile, null);
                if (loaded == null) {
                    master.reportStatus("Attempt to load file " + fc.openFile + " failed!");
                    return;
                }
                ...
                if (loaded instanceof TimeGraph) {
                    ...
                    gc = new TimeGraphController(interp, fc.openFile.getName());
                } else if (loaded instanceof Graph) {
                    Graph<Integer> gl = (Graph<Integer>) loaded;
                    gc = new GraphController(gl, fc.openFile.getName());
                        ...
                        if (o1.getClass().equals(Object[].class)) {
                            ...
                            if (o2.length >= 2 && o2[1].getClass().equals(String.class)) {
                                ...
                                for (Integer i : vg2.nodes()) {
                                    ...
                                    File imageFile = new File(fc.openFile.getParent(), fileName);
                                    try {
    ...
    class SaveAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (fc.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                ...
                GraphType saveType = loader.saveGraph(active, gc.getNodePositions(), fc.openFile);
                if (saveType == null)
                    gc.reportStatus("Attempt to save file " + fc.openFile + " failed!");
                else
                    gc.reportStatus("Saved graph to file " + fc.openFile + ".");
            }
        }
    }
    ...
    public static class ExportImageAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (fc.openFile != null) {
                fc.setCurrentDirectory(fc.openFile);
                File der = deriveFile(fc.openFile, ext[0]);
                fc.setSelectedFile(der);
            }
            if (fc.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
    ...
    public static class MovieAction extends AbstractAction implements Runnable {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (gc instanceof TimeGraphController) {
                ...
                if (fc.openFile != null) {
                    fc.setCurrentDirectory(fc.openFile);
                    fc.setSelectedFile(deriveFile(fc.openFile,".mov"));
                }
                if (fc.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                    movFile = fc.getSelectedFile();
                    pm = new ProgressMonitor(tgm, "Exporting graph to .mov file", "", 0, 1);
        ...
        public void run() {
            ...
            ExportMovieTask task = new ExportMovieTask((TimeGraphController) gc, tgm, me, pm);
            if (((TimeGraphController)gc).getTimeGraphManager().getLayoutAlgorithm() != null)
